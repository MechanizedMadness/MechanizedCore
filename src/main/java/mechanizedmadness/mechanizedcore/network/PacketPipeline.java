 ...
 * the packets themselves. Create a new PacketPipeline for your mod and add
 * packets in the initialise phase of your mod then run the required methods.
 * 
...
public class PacketPipeline extends MessageToMessageCodec<FMLProxyPacket, AbstractPacket> {
    ...
    private List<AbstractPacket> packetsToRegister = new ArrayList<AbstractPacket>();
    ...
    private void registerDefaultPackets() {
        registerPacket(PacketProgressTile.class);
    }

    private void registerPackets() {
        if (!packetsToRegister.isEmpty()) {
            for (int i = 0; i < packetsToRegister.size(); i++) {
                registerPacket(packetsToRegister.get(i).getClass());
            }
        }
    }

    /**
     * Adds a packet to be registered. Run before initalise.
     * 
     * @param packet
     *            Packet to be registered
     */
    public void addPacket(AbstractPacket packet) {
        packetsToRegister.add(packet);
    }

    /**
     * Call at init method of your @Mod Class.
     * 
    ...
    /**
     * Call at postInit method of your @Mod Class.
     * 
     * @see cpw.mods.fml.common.Mod
     */
